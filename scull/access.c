...
struct file_operations scull_sngl_fops = {
	...
	.read =       	scull_read,
	.write =      	scull_write,
	// TODO ioctl isn't specified like this any more
	//.ioctl =      	scull_ioctl,
	.open =       	scull_s_open,
...
static int scull_u_open(struct inode *inode, struct file *filp)
{
	...
	// TODO: There are two cred instances in task_struct; need to
	// figure out which one I should be using (and if this is even
...
struct file_operations scull_user_fops = {
	...
	// TODO ioctl is no longer specified this way, need to figure
...
struct file_operations scull_priv_fops = {
	...
	// TODO ioctl is no longer specified this way
	//.ioctl =    scull_ioctl,
	.open =     scull_c_open,
